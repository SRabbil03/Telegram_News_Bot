...
# Render-এর পোর্ট বাইন্ডিং প্রবলেম সমাধানের জন্য ছোট একটি Flask সার্ভার
app_flask = Flask(__name__)

@app_flask.route('/')
def home():
    return "Telegram News Bot is running successfully!"

def run_flask():
    port = int(os.environ.get("PORT", 10000))
    app_flask.run(host="0.0.0.0", port=port)

# টেলিগ্রাম বট টোকেন এবং জিমেইল কনফিগারেশন
...
async def receive_image_and_send(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text(f"❌ জিমেইল কানেকশনে সমস্যা হয়েছে: {e}")
...
def main():
    # ব্যাকগ্রাউন্ডে ফ্লাস্ক সার্ভার চালু করা যাতে Render পোর্ট পেয়ে যায়
    ...
    print("Bot with Dropdown Selection & Flask Port Binding is running...")
    app.run_polling()
